...
my @bamfiles = </local/projects-t3/SerreDLab-3/kieran.tebben/mali/sample_lists/*subset.bam>;
my $bam;

open(OUT2, ">", "/local/projects-t3/SerreDLab-3/kieran.tebben/mali/sample_lists/percent_duplicate_redo.txt");
